// Use direct imports for better ES module compatibility
  ...
  try {
    ...
    try {
      ...
      browser = await puppeteer.launch({
        ...
        executablePath: isRunningOnVercel ? await chromium.executablePath() : undefined,
        headless: true,
      });
      ...
      console.log(`PDF API: Navigating to ${invoiceUrl}`);
